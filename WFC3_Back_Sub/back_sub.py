...
G102_zodi = fits.open(os.path.join(module_path,"data/G102_Zodi_CLN8_V7b_clean.fits"))[1].data 
G102_HeI = fits.open(os.path.join(module_path,"data/G102_HeI_clean.fits"))[1].data 
G102_Scatter = fits.open(os.path.join(module_path,"data/G102_Scatter_clean.fits"))[1].data 
...
G141_HeI = fits.open(os.path.join(module_path,"data/G141_HeI_clean.fits"))[1].data 
G141_Scatter = fits.open(os.path.join(module_path,"data/G141_Scatter_clean.fits"))[1].data 
